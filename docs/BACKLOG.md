...
| US-021 | Como asistente, quiero recibir mi entrada con el arte oficial del evento para reconocerla y compartirla, sin perder la lectura del QR en puerta. | P2 | Pendiente | SDD con las seis decisiones cerradas; `sharp` sobre marco PNG 621×1080, 19 KB por entrada; QR verificado con `jsqr`; falta prueba en celulares reales |
