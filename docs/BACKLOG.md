...
| US-021 | Como asistente, quiero recibir mi entrada con el arte oficial del evento para reconocerla y compartirla, sin perder la lectura del QR en puerta. | P2 | Pendiente | SDD; marco `Oficial redes` 172×300 pt; decisiones abiertas de destino, composición y peso |
