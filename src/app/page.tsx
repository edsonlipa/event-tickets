...
export default async function Home() {
  ...
  if (evento) return <FormularioCompra evento={{ nombre: evento.nombre, fecha: formatearFechaHora(evento.fecha), lugar: evento.lugar, precioUnitario: Number(evento.precio_unitario), yapeNumero: evento.yape_numero, yapeTitular: evento.yape_titular, yapeQrUrl: evento.yape_qr_url }} />;
